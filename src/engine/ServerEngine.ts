...
export default class ServerEngine implements EngineInterface {
  ...
  snapshotListener<T extends Model>(name: string, blueprint: Blueprint<T>, id: string, onRecieve: ((entity: T) => void), onError: ((error: Error) => void) = null): void {
      throw new Error('Not implemented')
  }
  

  snapshotListenerMany<T extends Model>(name: string, blueprint: Blueprint<T>, queryParams: QueryParam[], onRecieve: ((entities: T[]) => void), onError: ((error: Error) => void) = null): void {
    throw new Error('Not implemented')
  }
