...
export default abstract class Repository<T extends Model> {
    ...
    snapshotListener(name: string, id: string, routeParams: any, onRecieve: ((entity: T) => void)): void;
    snapshotListenerForModel(name: string, model: T, onRecieve: ((entity: T) => void)): void;
    snapshotListenerMany(name: string, queryParams: QueryParam[], routeParams: any, onRecieve: ((entity: T[]) => void)): void;
